        ...
        <div style={{ width:'100%', maxWidth:400, padding:'0 24px', animation:'fadeUp 0.5s ease both' }}>
          <div className="glass-card" style={{ padding:'40px 36px', background:'rgba(255,255,255,0.78)', backdropFilter:'blur(20px)' }}>
            ...
            <form onSubmit={handleSubmit} style={{ display:'flex', flexDirection:'column', gap:14 }}>
              <input className="form-input" type="email"    placeholder="Inserisci email"    value={email}    onChange={e=>setEmail(e.target.value)}    required />
              <input className="form-input" type="password" placeholder="Inserisci password" value={password} onChange={e=>setPassword(e.target.value)} required />
